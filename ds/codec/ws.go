...
func (c *WSconn) OutputData(msg *ds.MsgBuffer) { // 专用的server输出
...
var write_pool = sync.Pool{New: func() interface{} {
	return &messageWriter{writeBuf: &ds.MsgBuffer{}, outbuf: make([]byte, defaultWriteBufferSize+msgheader+msglength8+msgmask)}
}}

type messageWriter struct {
	compress bool          // whether next call to flushFrame should set RSV1
	writeBuf *ds.MsgBuffer // :
	outbuf   []byte
}
